...
RETURNS TABLE(geometry geometry, class TEXT, network INTEGER, name TEXT, ref TEXT, colour TEXT, ascent INTEGER, descent INTEGER, distance INTEGER, website TEXT) AS $$
    SELECT *
